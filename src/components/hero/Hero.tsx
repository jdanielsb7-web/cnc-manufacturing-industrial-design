...
export const Hero = ({ }) => {
    return (
        <div className="relative isolate min-h-[clamp(640px,100dvh,800px)] flex items-center overflow-hidden bg-[#091D36]">
            ...
            <motion.div {...staggerContainerOnLoad} className="relative max-w-7xl mx-auto px-5 pt-26 pb-10 lg:pt-16 lg:pb-0 flex flex-col lg:flex-row lg:items-start justify-between gap-10 lg:gap-16 w-full">
